...
<a href="https://github.com/dvnrsn/blog/generate">
...
Prepare your repository for use by removing blog branding and replacing it with your own project name and description.
...
<details>
<summary>2. Run the "Remove blog branding" action</summary>

1. Click the "Actions" tab in the top navigation of your repository
2. Click the "Remove blog branding" workflow
...
Start your project with blog by clicking the "Use this template" button below:
...
Deploy your blog site for **free** with GitHub Pages:
...
Deploy blog to [Netlify](https://netlify.com) for **free**!
...
Deploy blog to [Cloudflare Pages](https://pages.cloudflare.com/) for global edge performance:
...
blog includes additional features that are disabled by default. Enable them when you need them:
...
- Reusable components via [eleventy-plugin-reusable-components](https://github.com/dvnrsn/eleventy-plugin-reusable-components)
...
```text
example.com                 # → Root of your blog project
...
├── README.blog.md     # → Template documentation
